...
const V_OM_ROOT_URL_HTTP_ = "http://m.11st.co.kr/MW"
...
export function getOmRootMobileURL(){
    return (typeof _OM_ROOT_URL_HTTP_ == "undefined") ? V_OM_ROOT_URL_HTTP_ : _OM_ROOT_URL_HTTP_;
}